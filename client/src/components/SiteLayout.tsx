    ...
    <div className="site-shell">
      <header className="site-header">
        <div className="container nav-inner">
          <Link href="/" className="brand" onClick={() => setOpen(false)}>
            <img src="/manus-storage/vps-addon-logo_754bc77b.png" alt="" className="brand-mark" />
      ...
      <footer className="site-footer">
        <div className="container footer-grid">
          <div><Link href="/" className="brand footer-brand"><img src="/manus-storage/vps-addon-logo_754bc77b.png" alt="" className="brand-mark" /><span><strong>VPS</strong><em>/ ADDON</em></span></Link><p className="footer-copy">Resource tambahan yang jelas, cepat, dan siap menemani website kamu tumbuh.</p></div>
          ...
          <div><p className="footer-label">Hubungi langsung</p><div className="footer-links"><a href="https://wa.me/6281234567890"><MessageCircle size={16}/> WhatsApp tim</a><a href="mailto:halo@vpsaddon.id">halo@vpsaddon.id</a></div></div>
        </div>
